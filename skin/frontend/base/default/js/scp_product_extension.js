...
Product.Config.prototype.updateProductSku = function(productId) {
    ...
    if (productId && this.config.childProducts[productId].sku) {
        ...
        $$('#product_addtocart_form div.product-conf-sku').each(function(el) {
            el.show();
        });
    }else{
        $$('#product_addtocart_form div.product-conf-sku').each(function(el) {
    ...
    $$('#product_addtocart_form div.product-conf-sku p span').each(function(el) {
        el.innerHTML = " " + sku;
    });
...
Product.Config.prototype.updateProductShortDescription = function(productId) {
    ...
    shortDescription = tmp.textContent || tmp.innerText || "";
    shortDescription = shortDescription.substring(0, 600);
    $$('#product_addtocart_form div.short-description div.std').each(function(el) {
        el.innerText = shortDescription;
    });
};
...
Product.Config.prototype.fillSelect = function(element){
    ...
    element.options[0].innerHTML = this.config.labelsAttribute[attributeId];

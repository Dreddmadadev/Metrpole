 ...
 *
 */
class Customweb_BNPMercanetCw_OnepageController extends Mage_Checkout_Controller_Action {

	/**
	 *
	 * @return Customweb_BNPMercanetCw_OnepageController
	 */
	...
	protected function _getPaymentMethodsHtml(){
		...
		foreach($layout->getAllBlocks() as $block){
			if($block instanceof Customweb_BNPMercanetCw_Block_Form){

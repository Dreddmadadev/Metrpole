...
class Customweb_BNPMercanetCw_ProcessController extends Customweb_BNPMercanetCw_Controller_Action
{
	public function processAction()
	{
		...
		$adapter = Mage::getModel('bnpmercanetcw/endpointAdapter');
	...
	public function dummyAction()
	{
		...
		$this->getLayout()->getBlock('content')->append(
			$this->getLayout()->createBlock('bnpmercanetcw/dummy')
		);
	...
	public function getVisibleFieldsAction()
	{
		...
		if($payment != null){
			...
			$this->getHelper()->log("BNPMercanetCw : ProcessController::getVisibleFieldsAction() Could not find payment method '" . $_REQUEST['payment_method']);
			$html = Mage::helper("BNPMercanetCw")->__("Technical issue: This payment methods is not available at the moment.");
		}

...
class Customweb_BNPMercanetCw_MotobnpmercanetcwController extends Mage_Adminhtml_Controller_Action
{
	
	protected function _isAllowed()
	{
		return Mage::getSingleton('admin/session')->isAllowed('sales/bnpmercanetcw/bnpmercanetcw_moto');
	}
	...
	public function processAction()
	{
		...
		$this->getLayout()
			->getBlock('head')
			->addCss('css/bnpmercanetcw.css');
		$this->getLayout()
			->getBlock('content')
			->append($this->getLayout()
				->createBlock('bnpmercanetcw/moto'));

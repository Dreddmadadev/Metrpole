 ...
 * 
 */
class Customweb_BNPMercanetCw_ConfigbnpmercanetcwController extends Mage_Adminhtml_Controller_Action {

	protected function _isAllowed(){
		return Mage::getSingleton('admin/session')->isAllowed('system/bnpmercanetcw');
	}
	...
	public function indexAction(){
		...
		if (!empty($forms)){
			...
			$this->_title('BNP Paribas Mercanet');
			
			$this->_setActiveMenu('system/bnpmercanetcw');
	...
	public function viewAction(){
		...
		if (!empty($machineName)) {
			...
			$this->_addContent($this->getLayout()->createBlock('bnpmercanetcw/adminhtml_backendForm_form')->setForm($form));
		}
	...
	private function updateStoreHierarchy(){
		...
		Customweb_BNPMercanetCw_Model_ConfigurationAdapter::setStoreHierarchy($storeHierarchy);
	}
	...
	private function getFormAdapter(){
		$container = Mage::helper('BNPMercanetCw')->createContainer();

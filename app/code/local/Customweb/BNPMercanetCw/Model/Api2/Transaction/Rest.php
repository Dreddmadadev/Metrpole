...
class Customweb_BNPMercanetCw_Model_Api2_Transaction_Rest extends Customweb_BNPMercanetCw_Model_Api2_Transaction
{
	...
	{
		$transaction = Mage::getModel('bnpmercanetcw/transaction')->load($id);
	...
	protected function prepareEntry(Customweb_BNPMercanetCw_Model_Transaction $transaction)
	{

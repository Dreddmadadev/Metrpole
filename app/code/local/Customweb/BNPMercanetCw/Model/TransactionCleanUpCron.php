 ...
 */
class Customweb_BNPMercanetCw_Model_TransactionCleanUpCron {
	...
	public function cleanUp() {
		...
		$failedCollection = Mage::getModel('bnpmercanetcw/transaction')->getCollection()
		...
		$pendingCollection = Mage::getModel('bnpmercanetcw/transaction')->getCollection()
		...
		$noStatusCollection = Mage::getModel('bnpmercanetcw/transaction')->getCollection()

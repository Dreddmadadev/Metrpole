...
class Customweb_BNPMercanetCw_Model_BackendFormRenderer extends Customweb_Form_Renderer
{
	private $formId = null;
	...
	public function __construct()
	{
		...
		$this->setControlCssClassResolver(Mage::getModel('bnpmercanetcw/controlCssClassResolver'));
	...
	{
		if (Mage::getModel('bnpmercanetcw/configurationAdapter')->getStoreHierarchy() == null) {
			return '';
		}
	...
	protected function renderElementScopeControl(Customweb_Form_IElement $element)
	{
		...
		$output .= '<label for="' . $scopeControlId . '">' . Mage::helper('BNPMercanetCw')->__('Use Default') . '</label>';
		return $output;
	}
	...
	{
		$storeHierarchy = Mage::getModel('bnpmercanetcw/configurationAdapter')->getStoreHierarchy();

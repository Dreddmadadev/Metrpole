 ...
 * @Bean
 */
class Customweb_BNPMercanetCw_Model_UpdateHandler implements Customweb_Payment_Update_IHandler
{
	public function getContainer() {
		return Mage::helper('BNPMercanetCw')->createContainer();
	}
	...
	public function log($message, $type) {
		...
		Mage::helper('BNPMercanetCw')->log($message, $level);
	}

	public function getScheduledTransactionIds() {
		$resource = Mage::getSingleton('core/resource');
		$readConnection = $resource->getConnection('core_read');
		$query = 'SELECT transaction_id FROM ' . $resource->getTableName('bnpmercanetcw/transaction')

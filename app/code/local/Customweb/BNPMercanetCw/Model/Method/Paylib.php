...
class Customweb_BNPMercanetCw_Model_Method_Paylib extends Customweb_BNPMercanetCw_Model_Method
{
	protected $_code = 'bnpmercanetcw_paylib';
	protected $paymentMethodName = 'paylib';

...
class Customweb_BNPMercanetCw_Model_Method_Acceptgiro extends Customweb_BNPMercanetCw_Model_Method
{
	protected $_code = 'bnpmercanetcw_acceptgiro';
	protected $paymentMethodName = 'acceptgiro';

...
class Customweb_BNPMercanetCw_Model_Method_MiniTix extends Customweb_BNPMercanetCw_Model_Method
{
	protected $_code = 'bnpmercanetcw_minitix';
	protected $paymentMethodName = 'minitix';

...
class Customweb_BNPMercanetCw_Model_Method_CetelemThree extends Customweb_BNPMercanetCw_Model_Method
{
	protected $_code = 'bnpmercanetcw_cetelemthree';
	protected $paymentMethodName = 'cetelemthree';

...
class Customweb_BNPMercanetCw_Model_Method_CetelemFour extends Customweb_BNPMercanetCw_Model_Method
{
	protected $_code = 'bnpmercanetcw_cetelemfour';
	protected $paymentMethodName = 'cetelemfour';

...
class Customweb_BNPMercanetCw_Model_Asset_JsResolver implements Customweb_Asset_IResolver
{
	...
	private function getJsFilePath($identifier) {
		return Mage::getBaseDir() . '/js/customweb/bnpmercanetcw/assets/' . $identifier;
	}
	
	private function getJsUrl($identifier) {
		return Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS) . 'customweb/bnpmercanetcw/assets/' . $identifier;
	}
}
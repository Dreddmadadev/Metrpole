...
class Customweb_BNPMercanetCw_Model_Asset_SkinResolver implements Customweb_Asset_IResolver
{
	...
	private function getSkinFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getFilename('customweb/bnpmercanetcw/assets/' . $identifier, array(
			'_type' => 'skin'
		));
	}
	
	private function getSkinUrl($identifier) {
		return Mage::getSingleton('core/design_package')->getSkinUrl('customweb/bnpmercanetcw/assets/' . $identifier);
	}
}
...
class Customweb_BNPMercanetCw_Block_Adminhtml_BackendForm_Switcher extends Mage_Adminhtml_Block_Template
{
    protected function _prepareLayout()
    {
        $this->setTemplate('customweb/bnpmercanetcw/backendform/switcher.phtml');

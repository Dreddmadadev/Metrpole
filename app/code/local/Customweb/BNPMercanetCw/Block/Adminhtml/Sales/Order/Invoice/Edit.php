<?php
class Customweb_BNPMercanetCw_Block_Adminhtml_Sales_Order_Invoice_Edit  extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct()
    {
        $this->_objectId = 'order_id';
        $this->_controller = 'customweb_bnpmercanetcw_invoice';
        $this->_mode = 'edit';

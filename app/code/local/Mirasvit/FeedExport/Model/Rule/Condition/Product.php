...
class Mirasvit_FeedExport_Model_Rule_Condition_Product extends Mage_Rule_Model_Condition_Abstract
{
    ...
    protected function _addSpecialAttributes(array &$attributes)
    {
        $attributes = array_merge($attributes, array(
            'entity_id' => Mage::helper('feedexport')->__('Product Id'),
            ...
            'weight' => Mage::helper('feedexport')->__('Weight'),
            'final_price' => Mage::helper('feedexport')->__('Final Price'),
            ...
            'min_sale_qty' => Mage::helper('feedexport')->__('Minimum Qty Allowed in Shopping Cart'),
            'max_sale_qty' => Mage::helper('feedexport')->__('Maximum Qty Allowed in Shopping Cart'),
    ...
    public function collectValidatedAttributes($productCollection)
    {
        ...
        if (!in_array($attribute, array('category_ids', 'qty', 'php', 'is_in_stock', 'manage_stock', 'status_parent', 'is_salable', 'final_price', 'min_sale_qty', 'max_sale_qty'))) {
    ...
    public function validate(Varien_Object $object)
    {
        ...
        switch ($attrCode) {
             case 'entity_id':
                ...
                return $this->validateAttribute($entityId);
                break;
            ...
            case 'weight':
                ...
                return $this->validateAttribute($weight);
                break;

            case 'final_price':
                $finalPrice = $this->getFinalPrice($object);

                return $this->validateAttribute($finalPrice);
                break;
            ...
            case 'min_sale_qty':
                ...
                return $this->validateAttribute($stockItem->getData('min_sale_qty'));
                break;

            case 'max_sale_qty':
                $stockItem = Mage::getModel('cataloginventory/stock_item')->loadByProduct($object->getId());

                return $this->validateAttribute($stockItem->getData('max_sale_qty'));
                break;
    ...
    protected function getFinalPrice(Varien_Object $product)
    {

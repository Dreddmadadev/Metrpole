...
class Amasty_Gdpr_Model_Mysql4_CustomerData
{
    public function addCustomerData(Mage_Core_Model_Mysql4_Collection_Abstract $collection)
    {
    ...
    public function joinEAV(
        Mage_Core_Model_Mysql4_Collection_Abstract $collection,
        $attrCode,

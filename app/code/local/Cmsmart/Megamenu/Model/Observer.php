	...
	public function saveCategoryTop(Varien_Event_Observer $observer)
   	{
		...
		if(isset($dat['active_product']) && $dat['active_product']){
        ...
        if(isset($dat['active_static_block_top']) && $dat['active_static_block_top']) {
        ...
        if(isset($dat['active_static_block']) && $dat['active_static_block']) {
		  $data['active_static_block']             = $dat['active_static_block'];
        } else {
          $data['active_static_block']             = 0;  
        }
        
        if(isset($dat['active_static_block_left']) && $dat['active_static_block_left']) {
        ...
        if(isset($dat['active_static_block_bottom']) && $dat['active_static_block_bottom']) {
        ...
        if(isset($dat['active_static_block_right']) && $dat['active_static_block_right']) {

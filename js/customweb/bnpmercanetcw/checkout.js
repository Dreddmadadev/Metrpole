...
Customweb.BNPMercanetCw = Class.create({
	...
	sendFieldsToUrl : function(url, params)
	{
		var me = this,
			...
			'action' : url,
			'method' : 'post',
			'id' : 'customweb_bnpmercanetcw_form'
		});
	...
	createOrder : function(event)
	{
		if(this.isModulePaymentMethod()) {
            ...
            var loaderelement = new Element('div', {'id': 'onestepcheckout-place-order-loading-bnpmercanetcw'}).
	...
	createOrderFailureCallback : function(errors, valid)
	{
		...
		$('onestepcheckout-place-order-loading-bnpmercanetcw').remove();
		var submitelement = $('onestepcheckout-place-order');
